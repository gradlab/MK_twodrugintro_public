...
#SBATCH -o logs/threshold_analysis.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e logs/threshold_analysis.err  # File to which STDERR will be written, %j inserts jobid
...
# Run the R script
singularity exec --cleanenv --env R_LIBS_USER=${my_packages} ${rstudio_singularity_image} Rscript threshold_analysis.R
