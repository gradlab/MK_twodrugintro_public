...
#SBATCH -o logs/sens_analysis_prop_plots_%j.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e logs/sens_analysis_prop_plots_%j.err  # File to which STDERR will be written, %j inserts jobid
...
# Run the R script
singularity exec --cleanenv --env R_LIBS_USER=${my_packages} ${rstudio_singularity_image} Rscript sens_analysis_propplots.R
