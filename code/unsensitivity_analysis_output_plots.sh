...
#SBATCH -o logs/unsensitivity_analysis_output_plots_%j.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e logs/unsensitivity_analysis_output_plots_%j.err  # File to which STDERR will be written, %j inserts jobid
...
# Run the R script
singularity exec --cleanenv --env R_LIBS_USER=${my_packages} ${rstudio_singularity_image} Rscript unsensitivity_analysis_output_plots.R
