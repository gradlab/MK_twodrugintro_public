...
run_sens_analysis_6_13(model = equal_allocation_stochastic_6_7_brief, strategy = "equal allocation", threshold = 0.05,
                       paramdf = sensitive_lhs_filled, runs = 100, years = 28, times =c(730, 1000, 1825, 3650, 5000, 7300, 10000),
                       newfoldername = "ea_sens_fixed_613", prefix = "ea_sens")
