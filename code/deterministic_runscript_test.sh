...
#SBATCH -o logs/6-27_dettest.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e logs/6-27_dettest.err  # File to which STDERR will be written, %j inserts jobid
...
# Run the R script
singularity exec --cleanenv --env R_LIBS_USER=${my_packages} ${rstudio_singularity_image} Rscript deterministic_runscript.R
